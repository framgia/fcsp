$(document).ready(function(){
  ...
  $('body').on('click', '.edit-user-language .save', function(){
    var id_language = $(this).closest('.user-language').attr('id').match(/\d/g).join('');
    var url = '/user_languages/'+id_language;
    var inputData = {
      user_language: {
        level: $(this).closest('.edit-user-language').find('.select-language :selected').text()
      },
      id: id_language
    };
